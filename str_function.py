...
print(python.lower()) # python is amazing ,전부 소문자화
print(python.upper()) # PYTHON IS AMAZING ,전부 대문자화
print(python[0].isupper()) # True : 0 번째 인덱스의 값이 대문자인지 확인
print(len(python)) # 17 : 띄어쓰기를 포함한 문자열의 전체 길이 (length)
print(python.replace("Python", "Java")) # Java is Amazing ,Python을 Java로 변경


#print(python.index("Java")) # 원하는 문자 위치 출력, 없으면 에러가 발생하며 프로그램 종료
